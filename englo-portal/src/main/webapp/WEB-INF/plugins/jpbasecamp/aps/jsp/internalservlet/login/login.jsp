...
<div >
   ...
   <div class="jpbasecam-login" style="margin-top: 2em;">
      <h2 class="title4">
      ...
      <s:if test="%{!#logged}">
         <s:form action="access" namespace="/do/authentication">
            ...
            <wpsf:submit type="button" cssClass="btn btn-default englo_button signIn">
      ...
      <s:else>
         ...
         <a
            class="btn btn-default englo_button signIn"
