...
<div class="corniceGit">
   <div class="jpcrowdsourcing viewIdea">
      ...
      <s:if test="#idea!=null">
         ...
         <form action="${listPage}" method="post" class="">
            <s:set name="labelList"><wp:i18n key="jpcollaboration_BACK_TO_LIST" escapeXml="false" /></s:set>
            <p><wpsf:submit value="%{#labelList}" cssClass="englo_button" /></p>
         </form>
         <%-- //back to list// --%>

         <div class="todoList">
            <h3 class="title"><s:property value="#idea.title" /></h3>
            <div style="padding:1em;">
               ...
               <h4 style="margin-top:2em;" id="jpcrdsrc_comments_<s:property value="#idea.id" />"><wp:i18n key="jpcollaboration_IDEA_COMMENTS" /></h4>
               ...
               <c:choose>
                  <c:when test="${sessionScope.currentUser != 'guest'}">
                     <form action="<wp:action path="/ExtStr2/do/collaboration/FrontEnd/Idea/saveComment.action"/>" method="post" accept-charset="UTF-8">
                        ...
                        <p><wpsf:submit value="%{#labelSave}" cssClass="englo_button" /></p>
         ...
         <!--            <form action="${listPage}" method="post" class="form-inline display-inline">
            ...
            <s:else>
               <div class="alert alert-error">
                  <h3 class="alert-heading"><wp:i18n key="jpcollaboration_IDEA_DETAILS" /></h3>
                  <p>
