...
<div class="jpcrowdsourcing listIdea corniceGit">
   ...
   <h2 class="title"><wp:i18n key="jpcollaboration_LIST_IDEA_TITLE" /></h2>
         ...
         <wp:pager listName="currentList" objectName="groupIdea" pagerIdFromFrame="true" max="5" pagerId="listIdeaPager">
            ...
            <c:forEach var="ideaId" items="${currentList}" begin="${groupIdea.begin}" end="${groupIdea.end}" varStatus="status">
               ...
               <wp:url var="viewIdea_pageUrl" page="${viewIdea_page.code}"><wp:urlPar name="ideaId" ><s:property value="#idea.id"/></wp:urlPar></wp:url>
                     ...
                     <h4><a href="<c:out value="${viewIdea_pageUrl}" />"><s:property value="#idea.title" /></a></h4>
               ...
               <p style="padding:1em;">
                  <img src="<c:out value="${currentAvatar}" />" class="img-polaroid" width="32" title="<wp:i18n key="jpcollaboration_IDEA_PUBBL" />&#32;<s:property value="#idea.username"/>&#32;<s:date name="#idea.pubDate" />" />&#32;<s:property value="#idea.username"/>&#32;<span title="<s:date name="#idea.pubDate" />"><s:date name="#idea.pubDate" nice="true"/></span></p>
               ...
               <form action="<wp:action path="/ExtStr2/do/collaboration/FrontEnd/Idea/Manage/ideaLike.action" />" method="post" class="form-inline display-inline">
                  ...
                  <wpsf:submit value="%{#labelSubmit}" cssClass="englo_button" />
                  <span class="badge badge-success" title="<s:property value="#idea.votePositive" /> <wp:i18n key="jpcollaboration_IDEA_VOTE_AGREE" />">&#32;
                     <i class="icon-thumbs-up icon-white"></i>&#32;<s:property value="#idea.votePositive" /></span>
               </form>
               ...
               <form action="<wp:action path="/ExtStr2/do/collaboration/FrontEnd/Idea/Manage/ideaUnlike.action" />" method="post" class="form-inline display-inline">
                  ...
                  <span class="badge badge-important" title="<s:property value="#idea.voteNegative" /> <wp:i18n key="jpcollaboration_IDEA_VOTE_DISAGREE" />">&#32;<s:property value="#idea.voteNegative" />&#32;<i class="icon-thumbs-down icon-white"></i></span>&#32;<wpsf:submit value="%{#labelSubmit}" cssClass="englo_button" />
               </form>

               <p class="margin-medium-vertical" style="margin-bottom: 2em;margin-top: 1em;">
