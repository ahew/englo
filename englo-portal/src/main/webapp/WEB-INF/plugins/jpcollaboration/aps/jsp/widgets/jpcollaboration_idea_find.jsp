...
<div class="jpcrowdsourcing jpcrowdsourcing_idea_find" style="margin-top:2em;">
   <h1 class="title"><wp:i18n key="jpcollaboration_TITLE_SEARCH" /></h1>
   ...
   <form action="<wp:url page="${listIdea_page.code}" />" method="get" style="padding:.2em">
      <input type="hidden" name="jpcrowdsourcing_fastInstanceCode" value="<c:out value="${instanceVar}" />" />

      <p>
         <label for="jpcrowdsourcing_search_for"><span class="search3Col"><wp:i18n key="jpcollaboration_SEARCH_FOR" /><span></label>
                  ...
                  <c:if test="${not empty categoryInfoList}">
                     <p>
                        <label for="jpcrowdsourcing_search_in"><span class="search3Col">In</span></label>
                  ...
                  <p><input type="submit" value="<wp:i18n key="jpcollaboration_SEARCH" />" class="btn englo_button" /></p>
                  </p>
                  </form>
                  </div>