...
INSERT INTO guifragment (code, widgettypecode, plugincode, gui, defaultgui, locked) VALUES ('basecamp-widget-project_list', 'jpbasecamp_project_list', 'jpbasecamp', ' 
<#assign c=JspTaglibs["http://java.sun.com/jsp/jstl/core"]>
<#assign s=JspTaglibs["/struts-tags"]>
<#assign wp=JspTaglibs["/aps-core"]>
<#assign wpsa=JspTaglibs["/apsadmin-core"]>
...
<div class="cornice">
 ...
 <h2 class="title"><@wp.i18n key="jpbasecamp_LIST_PROJECTS" /></h2>
<div class="todoList">    
  <#if logged?? && logged>
<div style="display:inline-flex;">       

      <p>
         <button type="button" class="btn btn-info englo_button" data-toggle="collapse" data-target="#jpbasecamp-search-form">
...
<p style="margin-left:1em;">
         ...
         <a
            ...
            <@wp.i18n key="jpbasecamp_PROJECT_NEW" />&nbsp;<i class="icon-plus-sign"></i>
         </a>
      </p>
</div>
      <form id="jpbasecamp-search-form" action="<@wp.action path="/ExtStr2/do/jpbasecamp/FrontEnd/Project/search.action"/>" class="form-horizontal narrowSearch collapse">
            <div class="containerSearch">
            <#-- search by text (just cloned from the content viewer list search filter modules) -->
            <div class="control-group searchBar">
               <label for="jpbasecamp-search-searchText" class="control-label searchText"><@wp.i18n key="jpbasecamp_SEARCH_TEXT" /></label>
               <div class="controlsSearch">
                  <@wpsf.textfield name="searchText" id="jpbasecamp-search-searchText" cssClass="input-xlarge controlsSearch" />
               </div>
            </div>

            <#-- checkbox archived -->
            <div class="control-group">
               <label for="jpbasecamp.label.archived" class="control-labels">
            ...
            <#-- checkbox starred -->
            <div class="control-group">
               <label for="jpbasecamp.label.starred" class="control-labels">
            ...
            <div class="control-group">
               <label for="jpbasecamp.label.isClientProject" class="control-labels">
      ...
      <div class="row-fluid" style="margin-top:2em;">
         ...
         <div class="col-md-4" style="padding:1em;">		
            <article class="singleProject">
               <h3 class="projectTitle" style="text-align:center;">
                  
                  <@wp.pageWithWidget var="editPage" widgetTypeCode="jpbasecamp_project_view" />
                  <#assign editPageCode=editPage.code>
                  <a href="<@wp.url page="${editPageCode}">
                        <@wp.parameter name="pageCode"><@s.property value="homepage" /></@wp.parameter>
                        <@wp.parameter name="pid">${projectVar.id?string.computer}</@wp.parameter>
                     </@wp.url> ">
                     ${projectVar.name}
                  </a>
                  <a
...
<div class="col-md-12" style="text-align:center;">
      ...
      <#else>
      <h4 style="margin-top:2em;"><@wp.i18n key="jpbasecamp_MUST_LOGIN" /></h4>
      </#if>
   </section>
   <div>
...
</ul>', '<#assign c=JspTaglibs["http://java.sun.com/jsp/jstl/core"]>
<#assign wp=JspTaglibs["/aps-core"]>
