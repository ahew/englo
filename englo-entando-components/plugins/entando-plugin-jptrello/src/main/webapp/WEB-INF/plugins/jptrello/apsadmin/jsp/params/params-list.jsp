...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block">
		<s:text name="jptrello.title.paramsManagement" />
	</span>
</h1>
	...
	<div class="form-group">
	  ...
	  <div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div id="search-advanced" class="collapse well collapse-input-group">
				<div class="form-group">
					<label class="control-label col-sm-2 text-right" for="params_organization">
						<s:text name="label.organization"/>
					</label>
					<div class="col-sm-5">
						<wpsf:textfield
							id="params_organization"
							name="organization"
							cssClass="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2 text-right" for="params_api_key">
						<s:text name="label.api_key"/>
					</label>
					<div class="col-sm-5">
						<wpsf:textfield
							id="params_api_key"
				...
				<div class="form-group">
					<label class="control-label col-sm-2 text-right" for="params_api_secret">
						<s:text name="label.api_secret"/>
					</label>
					<div class="col-sm-5">
						<wpsf:textfield
							id="params_api_secret"
							name="api_secret"
							cssClass="form-control" />
					</div>
				</div>
...
<s:form action="search">
	<p class="sr-only">
		<wpsf:hidden name="id" />
		<wpsf:hidden name="organization" />
		<wpsf:hidden name="api_key" />
		<wpsf:hidden name="api_secret" />
	...
	<div class="table-responsive">
		<table class="table table-bordered">
			<tr>
				...
				<th><s:text name="label.api_key" /></th>
				<th><s:text name="label.api_secret" /></th>
			...
			<td class="text-center text-nowrap">
				...
				<div class="btn-group btn-group-xs">
					<a
						...
						title="<s:text name="jptrello.params.label.delete" />: <s:property value="#params_var.id" />"
						class="btn btn-warning"
						>
						<span class="icon fa fa-times-circle-o"></span>&#32;
						<span class="sr-only"><s:text name="jptrello.params.label.delete" /></span>
					</a>
				</div>
			</td>
					<td class="text-right"><code><s:property value="#params_var.id"/></code></td>
					<td><s:property value="#params_var.organization"/></td>
					<td><s:property value="#params_var.api_key"/></td>
					<td><s:property value="#params_var.api_secret"/></td>
	...
	<s:else>
		<div class="alert alert-info margin-base-vertical">
			<s:text name="jptrello.params.message.list.empty" />
		</div>
	</s:else>
</s:form>