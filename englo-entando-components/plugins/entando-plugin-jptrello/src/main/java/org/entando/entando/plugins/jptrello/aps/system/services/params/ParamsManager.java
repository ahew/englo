...
import org.entando.entando.plugins.jptrello.aps.system.services.params.event.ParamsChangedEvent;
...
import org.entando.entando.plugins.jptrello.aps.system.services.params.api.JAXBParams;
...
public class ParamsManager extends AbstractService implements IParamsManager {
    ...
    public List<Integer> getParamss() throws ApsSystemException {
        ...
        try {
            paramss = this.getParamsDAO().loadParamss();
        } catch (Throwable t) {
    ...
    public List<Integer> searchParamss(FieldSearchFilter filters[]) throws ApsSystemException {
        List<Integer> paramss = new ArrayList<Integer>();
        try {
            paramss = this.getParamsDAO().searchParamss(filters);
        } catch (Throwable t) {
