...
public class TrelloImpl implements Trello {
    ...
    * (non-Javadoc)
    *
    * @see org.trello4j.BoardService#getMembers
    
    ByBoard(java.lang.String)
    */
    @Override
    ...
    */
    ...
    @Override
    public Card deleteCard(final String cardId) {
        validateObjectId(cardId);
    ...
    */
    ...
    @Override
    public Board createBoard(String name, Map<String, String> keyValueMap) {
        final String url = TrelloURL
                .create(apiKey, TrelloURL.BOARD_POST_URL)
                .token(token)
                .build();
    ...
    @Override
    public Board updateBoard(String idBoard, Map<String, String> keyValueMap) {
        
        validateObjectId(idBoard);
        
        final String url = TrelloURL
                .create(apiKey, TrelloURL.BOARD_PUT_URL, idBoard)
                .token(token)
        ...
        return trelloObjFactory.createObject(new TypeToken<Board>() {
        }, doPut(url, new HashMap<String, String>()));
    }
    
    @Override
    public Card updateCardList(String idCard, String idList, Map<String, String> keyValueMap) {
        Map<String, String> args = new HashMap<String, String>();
        
        validateObjectId(idList);
        validateObjectId(idCard);
        // arguments needed to update the List the card belongs to
        args.put("value", idList);
        
        final String url = TrelloURL
                .create(apiKey, TrelloURL.CARD_LIST_MOVE_URL, idCard)
                .token(token)
                .arguments(args)
                .build();
        if (keyValueMap == null) {
    ...
    @Override
    public Card updateCard(String idCard, String idList, String descr, Map<String, String> keyValueMap) {
    ...
    */
    ...
    @Override
    public org.trello4j.model.List createList(final String name, Map<String, String> keyValueMap) {
//        validateObjectId(listId);
    ...
    @Deprecated
    @Override
    public org.trello4j.model.List closeList(final String listId, Map<String, String> keyValueMap) throws Throwable {
        validateObjectId(listId);
        
        final String url = TrelloURL
                .create(apiKey, TrelloURL.LIST_CLOSED_URL, listId)
                .token(token)
                .arguments(keyValueMap)
                .build();
    ...
    @Override
    public org.trello4j.model.List updateList(final String listId, Map<String, String> keyValueMap) throws Throwable {
        validateObjectId(listId);
        
        final String url = TrelloURL
                .create(apiKey, TrelloURL.LIST_PUT_URL, listId)
                .token(token)
                .arguments(keyValueMap)
                .build();
