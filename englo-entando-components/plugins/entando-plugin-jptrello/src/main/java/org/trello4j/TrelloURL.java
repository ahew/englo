...
public class TrelloURL {
    ...
    public static final String BOARD_PUT_URL = "https://api.trello.com/1/boards/{0}";
    ...
    public static final String CARD_LIST_MOVE_URL = "https://api.trello.com/1/cards/{0}/idList";
    ...
    public static final String LIST_CLOSED_URL = "https://api.trello.com/1/lists/{0}/closed";
    public static final String LIST_PUT_URL = "https://api.trello.com/1/lists/{0}";
    ...
    public TrelloURL arguments(Map<String, String> args) {
        if (null != args
                && !args.isEmpty()) {
            arguments = args;
        }
    ...
    /*
    * we always use '&' since there are already at least two arguments,
    * key and token
    */
    private String createRequestArguments() {
        ...
        if (null != arguments
            ...
            for (String key: arguments.keySet()) {
                String value = Util.URLEncode(arguments.get(key), "UTF-8");
