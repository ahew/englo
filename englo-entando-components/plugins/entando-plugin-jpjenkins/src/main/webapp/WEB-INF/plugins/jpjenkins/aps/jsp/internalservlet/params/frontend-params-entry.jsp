...
<s:if test="strutsAction==1">
	<h1><wp:i18n key="jpjenkins_PARAMS_NEW" /></h1>
</s:if>
<s:elseif test="strutsAction==2">
	<h1><wp:i18n key="jpjenkins_PARAMS_EDIT" /></h1>
</s:elseif>

<form action="<wp:action path="/ExtStr2/do/FrontEnd/jpjenkins/Params/save.action" />" method="post">
