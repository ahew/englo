...
<s:form action="saveConfig" namespace="/do/jpjenkins/Params/Page/SpecialWidget/jpjenkinsParamsConfig" cssClass="form-horizontal">
		...
		<div class="form-group margin-base-top">
			<div class="col-xs-12">
				...
				<div class="input-group">
					<wpsf:select cssClass="form-control" list="paramssId" name="id" id="id" cssClass="form-control" />
