...
<br/>
      ...
      <form class="todoList" style="margin-top:-1em;width:31.5em;" action="<wp:action path="/ExtStr2/do/jpbasecamp/FrontEnd/Project/updateTodo.action"/>" method="post">
	...
	<s:if test="%{(isTodolistEdit != null && isTodolistEdit) || (null == tdlid && null == tdid)}">
            ...
            <div class="form-horizontal" style="padding:1em;">
               <div class="control-groups">
                  <label class="control-labels"><wp:i18n key="jpbasecamp_TODOLIST_NEW_NAME" /></label>
                  <div class="controls2">
               ...
               <div class="control-groups">
                  <label class="control-labels"><wp:i18n key="jpbasecamp_TODOLIST_NEW_DESCRIPTION" /></label>
	...
	<s:if test="%{null != tdlid}">
            <div class="control-groups">
               <div class="todoList" style="width:30em;">
