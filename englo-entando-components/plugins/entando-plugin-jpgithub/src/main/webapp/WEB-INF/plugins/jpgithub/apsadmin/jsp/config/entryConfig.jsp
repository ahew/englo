...
<h1 class="panel panel-default title-page">
	<span class="panel-body display-block"><s:text name="title.jpgithub.config" /></span>
</h1>
...
<div id="main">
	<s:form action="save">
		...
		<fieldset class="col-xs-12">
			<legend><s:text name="jpgithub.legend.authentication.param" /></legend> 
			
			<div class="form-group">
				<label for="jpgithub.label.username"><s:text name="jpgithub.label.username" /></label>
				<wpsf:textfield name="config.username" id="username" cssClass="form-control" />
			</div>
			
			<div class="form-group">
				<label for="jpgithub.label.password"><s:text name="jpgithub.label.password" /></label>
		...
		<div class="form-horizontal">
			<div class="col-xs-12 col-sm-4 col-md-3 margin-small-vertical">
				<wpsf:submit action="test" type="button" cssClass="btn btn-primary btn-block">
					...
					<s:text name="jpgithub.label.test" />
				</wpsf:submit>
			</div>
